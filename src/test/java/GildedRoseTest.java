...
public class GildedRoseTest {
    ...
    private String extectedOutput = "Iteration 0:\n" +
    ...
    @Test
    public void regressionTestThroughTextBasedTesting() {
        OutputStream out = new ByteArrayOutputStream();
        PrintStream ps = new PrintStream(out);

        GildedRose.initItems();
        for (int i = 0; i <= 15; i++) {
            ps.println(String.format("Iteration %s:", i));
            GildedRose.printItems(ps);
            GildedRose.updateQuality();
        }

        assertEquals(extectedOutput, out.toString());
    }
